...
% visualizeHR_1.m
% inspired from visualizeHRV_1.m
...
for i_session = 1:length(session)    
    for i_effects = 1:length(effects)
        ...
        if strcmp(session{i_session}, 'ECG_2014_10_20') && strcmp(effects{i_effects}, 'PM2_alt')   
            ...
            cellReplace{3} = NaN;
            cellReplace{4} = NaN;
            cellReplace{5} = second_file_HR{2};
            cellReplace{6} = second_file_HR{3};
            cellReplace{7} = second_file_HR{4};
            cellReplace{8} = second_file_HR{5};
            cellReplace{9} = NaN;
            %
        ...
        elseif strcmp(session{i_session}, 'ECG_2014_10_20') && strcmp(effects{i_effects}, 'Yoga')            
            ...
            cellReplace{3} = second_file_HR{3};
            cellReplace{4} = NaN;
            cellReplace{5} = second_file_HR{4};
            cellReplace{6} = NaN;
            cellReplace{7} = second_file_HR{5};
            cellReplace{8} = second_file_HR{6};
            cellReplace{9} = NaN;
            %
            second_file_HR = cellReplace;
        ...
        elseif strcmp(session{i_session}, 'ECG_2014_10_21') && strcmp(effects{i_effects}, 'PM2_alt')            
            ...
            cellReplace{2} = first_file_HR{2};
            cellReplace{3} = first_file_HR{3};
            cellReplace{4} = NaN;
            cellReplace{5} = first_file_HR{4};
            cellReplace{6} = first_file_HR{5};
            cellReplace{7} = first_file_HR{6};
            cellReplace{8} = first_file_HR{7};
            %
            first_file_HR = cellReplace;
            
            cellReplace2 = cell(8, 1);
            cellReplace2{1} = second_file_HR{1};
            cellReplace2{2} = second_file_HR{2};
            cellReplace2{3} = second_file_HR{3};
            cellReplace2{4} = NaN;
            cellReplace2{5} = NaN;
            cellReplace2{6} = second_file_HR{4};
            cellReplace2{7} = second_file_HR{5};
            cellReplace2{8} = second_file_HR{6};
            %
        ...
        elseif strcmp(session{i_session}, 'ECG_2014_10_21') && strcmp(effects{i_effects}, 'Yoga')
            ...
            cellReplace{2} = second_file_HR{2};
            cellReplace{3} = second_file_HR{3};
            cellReplace{4} = second_file_HR{4};
            cellReplace{5} = second_file_HR{5};
            cellReplace{6} = second_file_HR{6};
            cellReplace{7} = NaN;
            cellReplace{8} = NaN;
            cellReplace{9} = NaN;
            cellReplace{10} = second_file_HR{7};
            %
            second_file_HR = cellReplace;              
        end        
