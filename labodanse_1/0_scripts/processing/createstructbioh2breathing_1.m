...
% createstructurebioh2breathing_1.m
% adapted from createstructurebioh2breathing_3.m
...
for i_session = 5:length(directoryNames) % loop for each session
%for i_session = 4:4 % loop for each session    
    ...
    processingSteps = cellstr(['structure created on ', date, ' with createstructbioh2breathing_1.m']);   
