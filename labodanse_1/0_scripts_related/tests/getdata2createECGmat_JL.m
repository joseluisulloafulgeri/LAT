...
% USE: open all the sessions and subjects folders to extract RR bioharness data with the scrypt createIBItimeseries
% INPUT: directory of the sessions folder + the directory of the folder in which are stored the output files.
