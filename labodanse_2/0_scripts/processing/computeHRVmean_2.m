...
% computeHRVmean_2.m
% inspired from computeHRVmean_1.m
...
%for i_session = 2:2   
    ...
    %for i_effects = 2:2    
        ...
        if strcmp(session{i_session}, 'ECG_2014_12_11') && strcmp(effects{i_effects}, 'PM1_alt')
            ...
            completeSetMean(4, 2) = HRVmean_second_file(3);
            completeSetMean(5, 2) = HRVmean_second_file(4);
            completeSetMean(6, 2) = HRVmean_second_file(5);          
            %
            %
            ...
            completeSetSD(4, 2) = HRVstdev_second_file(3);
            completeSetSD(5, 2) = HRVstdev_second_file(4);
            completeSetSD(6, 2) = HRVstdev_second_file(5);             
        ...
        elseif strcmp(session{i_session}, 'ECG_2014_12_12') && strcmp(effects{i_effects}, 'PM1_alt')
            ...
            completeSetMean(3, 2) = HRVmean_second_file(2);
            completeSetMean(4, 2) = HRVmean_second_file(3);
            completeSetMean(5, 2) = HRVmean_second_file(4);
            completeSetMean(6, 2) = HRVmean_second_file(5);
            ...
            completeSetSD(3, 2) = HRVstdev_second_file(2);
            completeSetSD(4, 2) = HRVstdev_second_file(3);
            completeSetSD(5, 2) = HRVstdev_second_file(4);
            completeSetSD(6, 2) = HRVstdev_second_file(5);
        ...
        elseif strcmp(session{i_session}, 'ECG_2014_12_12') && strcmp(effects{i_effects}, 'PM2_alt')            
            ...
            completeSetMean(3, 1) = HRVmean_first_file(2);
            completeSetMean(4, 1) = HRVmean_first_file(3);
            ...
            completeSetSD(3, 1) = HRVstdev_first_file(2);
            completeSetSD(4, 1) = HRVstdev_first_file(3);
