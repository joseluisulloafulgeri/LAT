...
% computeHRmean_2.m
% inspired from computeHRmean_1.m
...
%session = {'ECG_2014_12_11'};
session = {'ECG_2014_12_12'};
...
for i_session = 1:length(session)
    for i_effects = 1:length(effects)
        ...
        if strcmp(session{i_session}, 'ECG_2014_12_11') && strcmp(effects{i_effects}, 'PM1_alt')
            ...
            completeSetMean(4, 2) = HRmean_second_file(3);
            completeSetMean(5, 2) = HRmean_second_file(4);
            completeSetMean(6, 2) = HRmean_second_file(5);          
            %
            %
            ...
            completeSetSD(4, 2) = HRstdev_second_file(3);
            completeSetSD(5, 2) = HRstdev_second_file(4);
            completeSetSD(6, 2) = HRstdev_second_file(5); 
            ...
            completeSetMeanAlt(4, 2) = HRmeanAlt_second_file(3);
            completeSetMeanAlt(5, 2) = HRmeanAlt_second_file(4);
            completeSetMeanAlt(6, 2) = HRmeanAlt_second_file(5);          
            %
            %
            ...
            completeSetSDAlt(4, 2) = HRstdevAlt_second_file(3);
            completeSetSDAlt(5, 2) = HRstdevAlt_second_file(4);
            completeSetSDAlt(6, 2) = HRstdevAlt_second_file(5); 
        ...
        elseif strcmp(session{i_session}, 'ECG_2014_12_12') && strcmp(effects{i_effects}, 'PM1_alt')
            ...
            completeSetMean(3, 2) = HRmean_second_file(2);
            completeSetMean(4, 2) = HRmean_second_file(3);
            completeSetMean(5, 2) = HRmean_second_file(4);
            completeSetMean(6, 2) = HRmean_second_file(5);
            ...
            completeSetSD(3, 2) = HRstdev_second_file(2);
            completeSetSD(4, 2) = HRstdev_second_file(3);
            completeSetSD(5, 2) = HRstdev_second_file(4);
            completeSetSD(6, 2) = HRstdev_second_file(5);
            ...
            completeSetMeanAlt(3, 2) = HRmeanAlt_second_file(2);
            completeSetMeanAlt(4, 2) = HRmeanAlt_second_file(3);
            completeSetMeanAlt(5, 2) = HRmeanAlt_second_file(4);
            completeSetMeanAlt(6, 2) = HRmeanAlt_second_file(5);
            ...
            completeSetSDAlt(3, 2) = HRstdevAlt_second_file(2);
            completeSetSDAlt(4, 2) = HRstdevAlt_second_file(3);
            completeSetSDAlt(5, 2) = HRstdevAlt_second_file(4);
            completeSetSDAlt(6, 2) = HRstdevAlt_second_file(5);
        ...
        elseif strcmp(session{i_session}, 'ECG_2014_12_12') && strcmp(effects{i_effects}, 'PM2_alt')            
            ...
            completeSetMean = zeros(5, 2);
            %
            completeSetMean(1, 1) = HRmean_first_file(1);
            completeSetMean(2, 1) = NaN;
            completeSetMean(3, 1) = HRmean_first_file(2);
            completeSetMean(4, 1) = HRmean_first_file(3);
            ...
            %
            %
            completeSetSD = zeros(5, 2);
            %
            completeSetSD(1, 1) = HRstdev_first_file(1);
            completeSetSD(2, 1) = NaN;
            completeSetSD(3, 1) = HRstdev_first_file(2);
            completeSetSD(4, 1) = HRstdev_first_file(3);
            ...
            completeSetMeanAlt = zeros(5, 2);
            %
            completeSetMeanAlt(1, 1) = HRmeanAlt_first_file(1);
            completeSetMeanAlt(2, 1) = NaN;
            completeSetMeanAlt(3, 1) = HRmeanAlt_first_file(2);
            completeSetMeanAlt(4, 1) = HRmeanAlt_first_file(3);
            ...
            %
            %
            completeSetSDAlt = zeros(5, 2);
            %
            completeSetSDAlt(1, 1) = HRstdevAlt_first_file(1);
            completeSetSDAlt(2, 1) = NaN;
            completeSetSDAlt(3, 1) = HRstdevAlt_first_file(2);
            completeSetSDAlt(4, 1) = HRstdevAlt_first_file(3);
