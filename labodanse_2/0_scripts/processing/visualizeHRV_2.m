...
for i_session = 2:length(session)
    for i_effects = 1:length(effects)
        ...
        if strcmp(session{i_session}, 'ECG_2014_12_11') && strcmp(effects{i_effects}, 'PM1_alt')   
            ...
            cellReplace{3} = NaN;
            cellReplace{4} = second_file_HRV{3};
            cellReplace{5} = second_file_HRV{4};
            cellReplace{6} = second_file_HRV{5};
            %
        ...
        elseif strcmp(session{i_session}, 'ECG_2014_12_12') && strcmp(effects{i_effects}, 'PM1_alt')            
            ...
            cellReplace{1} = second_file_HRV{1};
            cellReplace{2} = NaN;
            cellReplace{3} = second_file_HRV{2};
            cellReplace{4} = second_file_HRV{3};
            cellReplace{5} = second_file_HRV{4};
            cellReplace{6} = second_file_HRV{5};
            cellReplace{7} = NaN;
        ...
        elseif strcmp(session{i_session}, 'ECG_2014_12_12') && strcmp(effects{i_effects}, 'PM2_alt')            
            ...
            cellReplace{2} = NaN;
            cellReplace{3} = first_file_HRV{2};
            cellReplace{4} = first_file_HRV{3};
            ...
            cellReplace2{2} = NaN;
            cellReplace2{3} = second_file_HRV{2};
            cellReplace2{4} = second_file_HRV{3};
            cellReplace2{5} = second_file_HRV{4};
            %
