function humanDate = timestamps2humandate(timeStamps, miliseconds)
...
if miliseconds,
    convertedTime = datestr(timeStamps/86400000 + datenum(1970,1,1)); 
    % instead of 86400 cause taking miliseconds
else
    convertedTime = datestr(timeStamps/86400 + datenum(1970,1,1));
end
